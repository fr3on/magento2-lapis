...
class CreditmemoStateReader implements StateReaderInterface
{
    private const RESOURCE_ID = 'creditmemo';
    private const ENDPOINT_PATTERN = '/rest/V1/creditmemos/{id}';
    ...
    {
        // Core creditmemo states: 1=Pending, 2=Refunded, 3=Canceled
        $statesRaw = [
            1 => 'Pending',
            2 => 'Refunded',
            3 => 'Canceled'
    ...
    {
        $transitions = [
            ['pending', 'refunded', 'refund()', 'admin', 'POST /rest/V1/creditmemos/{id}/refund'],
